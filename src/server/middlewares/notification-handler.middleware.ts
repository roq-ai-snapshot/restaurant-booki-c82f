...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Order.create': {
    roles: ['owner', 'chef', 'waiter', 'restaurant-manager', 'restaurant-owner', 'wait-staff'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'chef', 'waiter', 'restaurant-manager', 'restaurant-owner', 'wait-staff'];
