  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Empowering Restaurants and Simplifying Dining. A new way to reserve your table and manage reservations, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Empowering Restaurants and Simplifying Dining. A new way to reserve your table and manage reservations, all in one place.`}
            </Text>
            <Box
